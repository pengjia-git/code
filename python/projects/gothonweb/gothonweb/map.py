...
central_corridor=Room("Central Corridor",
                      ...
                      -uct bomb from the Weapons Armory,put it in the birdge
                      ,and blow the ship up after getting into an escape pod.

                      You're running down the central coridor to the Weapons
                      Armory when aa Gothon jumps out,red scaly skin,dark grimy
                      teeath,and evil clown costume flowing around his hate 
...
laser_weapon_armory=Room("Laser Weapon Armory",
                         ...
                         It's dead quiet,too quiet. You stand up and run to the
                         far side of the room and find the neutron bomb in its
                         container. There's a keypad lock on the box and you 
                         need the code to get the bomb out. If you get the code
                         wrong 10 times then the lock closes forever and you 
                         can't get the bomb. The code is 3 digits.
                         """)

the_bridege = Room("The Bridge",
                   """
                   The container clicks open and seal breaks,letting gas out.
                   You grab the neutron bomb and run as fast as you can to the
                   bridge where you must place it in the right spot.

                   Your burst onto the Bridge with the netron destrut bomb under
                   your arm and surprise 5 Gothons who are trying to take 
...
escape_pod = Room("Escape pod",
                  ...
                  backward to the door,open it,and then carefully place the bomb
                  on the floor,pointing your blaster as it. You then jump back
                  through the door,punch the close button and blast the lock so
                  the Gothons cat't get out. Now that the bomb is placed you run
                  to the escape pod to get off this tin can.
                  You rush through the ship desperately trying to make it to the
                  escape pod before the whole ship explodes. It seems like
                  hardly any Gothons are on the ship,so your run is clear of 
                  interface. You get to the chamber with the escape pods,and now
                  need to pick one to take. Some of them could be damaged but 
                  you don't have time to look.There's five pods,which one do you
                  take?
                  """)
...
the_end_winner = ("The End",
                  ...
                  below. As it flies to the planet,you look back and see your
                  ship implode then explode like a bright star,taking out the
...
the_end_loser =("The End",
                ...
                escapes out into the void of space,the implode as the hull
...
the_bridege.add_paths({'throw the bomb':generic_death,
                       'slowly place the bomb':escape_pod})

laser_weapon_armory.add_paths({'0132':the_bridege,'*':generic_death})
